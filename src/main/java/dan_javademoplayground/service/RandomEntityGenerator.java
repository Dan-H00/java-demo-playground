...
public class RandomEntityGenerator {
    ...
    private static Wallet generateRandomWallet(double maxLiquidityValue, Random random) {
        ...
        // made sure that the value generated by random.nextInt(10) does not exceed the size of keys
        int endIndex = Math.min(keys.size(), random.nextInt(10));
        List<Liquidity> liquidityList = keys.subList(0, endIndex)
                .stream()
